 ...
 * `/api/config`, and the audit viewer does — but the sidebar and the account
 * page render before any fetch resolves, so asking would draw the signed-in
 * chrome for a moment on a deployment that has no accounts, then take it away.
 *
