      ...
      try {
        ...
        const realData = {
          chains: chainsFromApi.map(chainValue => ({
            ...
            traffic: MetricsService.formatTraffic(chainsResponse.chains[chainValue].requests_per_day),
          ...
          providers: providersFromApi.map(providerValue => ({
            ...
            traffic: MetricsService.formatTraffic(providersResponse.providers[providerValue].requests_per_day),
            uptime: MetricsService.formatPercentage(providersResponse.providers[providerValue].uptime),
            latency: MetricsService.formatLatency(providersResponse.providers[providerValue].latency_in_ms),
            sync: MetricsService.formatPercentage(providersResponse.providers[providerValue].freshness) // Using freshness as proxy for sync
          })),
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Detailed performance metrics for chains and providers
            </CardDescription>
          </div>
        </div>
      </CardHeader>
